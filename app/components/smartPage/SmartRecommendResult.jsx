            ...
            <div className="space-y-4">
              {mockPlan.days.map((d, i) => (
                <div key={i} className="mb-4">
                  <h3 className="text-base font-medium text-orange-500 mb-3">{d.title}</h3>
                  <div className="space-y-3">
                    {d.items.map((it, idx) => (
                      <div key={idx} className="flex gap-3 border-b border-gray-100 pb-3">
                        <div className="w-16 text-sm text-gray-500">{it.time}</div>
                        <div className="flex-1">
                          <div className="font-medium mb-1">{it.title}</div>
                          <div className="text-sm text-gray-500 mb-1">{it.desc}</div>
                        </div>
